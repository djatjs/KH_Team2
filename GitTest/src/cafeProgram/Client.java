...
public class Client {
	...
	private static void userMenu(int menu, Customer customer) throws IOException {
		  do {
		        userPrintMainMenu();
		        menu = scan.nextInt(); 
		        scan.nextLine();
	...
	private static void userRunMainMenu(int menu, Customer customer) {
	...
	private static void addstamp(Customer customer) {
		// 쿠폰에 도장찍기
