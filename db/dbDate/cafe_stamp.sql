...
CREATE TABLE `stamp` (
  ...
  `ST_M_ID` varchar(13) NOT NULL,
  `ST_COUNT` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`ST_KEY`),
  KEY `FK_Member_TO_STAMP_1` (`ST_M_ID`),
  CONSTRAINT `FK_Member_TO_STAMP_1` FOREIGN KEY (`ST_M_ID`) REFERENCES `member` (`M_ID`) ON DELETE CASCADE
...
INSERT INTO `stamp` VALUES (1,'123',2);
